...
int main(int argC, char** argv){
  ...
  for(int i=0; i<Rreal.size(); i++){
    ...
    //cout << Rreal.at(i) << " " << Phireal.at(i) << endl;
    //cout << Rreal.at(i) * sin(conv*Phireal.at(i)) << endl;
    //usleep(100000);
  }

  //cout << Xreal.size() << endl;
  //cout << Yreal.size() << endl;
  //usleep(1000000);
  ...
  for(int i=0; i<Rmock.size(); i++){
    ...
    //cout << Rmock.at(i) * sin(conv*Phimock.at(i)) << endl;
    //usleep(100000);
  }


  //cout << Xmock.size() << endl;
  //cout << Ymock.size() << endl;
  //usleep(1000000);
  ...
  makeHist(histRR, Ymock);
  //cout << "Making histograms..." << endl;
  makeHist(histDD, Yreal);
  //cout << "Making histograms..." << endl;
  makeCrossHist(histDR, Yreal, Ymock);
